...
$functionKey = CMA_ABSENCE_TYPE_QUERY_KEY;

function setCustomTitle()
{
    $pageTitle = "Employee Absence Type";
    return $pageTitle;
}
...
if ($wp_query->query_vars['id']) {
    ...
    $body['id'] = $id;
    $pageTitle = "Employee Absence Type #{$id}";
}

$url = "https://wrdsb-cma.azurewebsites.net/api/absence-type-query?code={$functionKey}";
$args = array(
    'timeout'     => 5,
    'redirection' => 5,
    'httpversion' => '1.0',
