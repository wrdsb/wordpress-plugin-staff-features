 ...
 */
class WorkplaceInspectionTeamSearch {
    ...
    public static function audit() {
        ...
        $search_params['filter']  = "post_type eq 'wit'";
        $search_params['orderby'] = 'post_title';
        $search_params['search']  = '*';
        $search_params['select']  = '*';
        $search_params['top']     = '200';

        $search = new WorkplaceInspectionTeamSearch($search_params);
        $search->run();
    ...
    public static function getBySchoolCode($schoolCode) {
        ...
        $search_params = [];
        $search_params['count']   = true;
        $search_params['filter']  = "post_type eq 'wit' and schoolCode eq '{$schoolCode}'";
        $search_params['orderby'] = 'post_title';
        $search_params['search']  = '*';
        $search_params['select']  = '*';
        $search_params['top']     = '200';
