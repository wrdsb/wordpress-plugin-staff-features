...
class EvacuationSitesSearch {
    ...
    public static function audit() {
        ...
        $search_params['filter']  = "post_type eq 'evacuationsites'";
        $search_params['orderby'] = 'post_title';
        $search_params['search']  = '*';
        $search_params['select']  = '*';
        $search_params['top']     = '200';

        $search = new EvacuationSitesSearch($search_params);
        $search->run();
    ...
    public static function getBySchoolCode($schoolCode) {
        ...
        $search_params = [];
        $search_params['count']   = true;
        $search_params['filter']  = "post_type eq 'evacuationsites' and schoolCode eq '{$schoolCode}'";
        $search_params['orderby'] = 'post_title';
        $search_params['search']  = '*';
        $search_params['select']  = '*';
        $search_params['top']     = '200';
