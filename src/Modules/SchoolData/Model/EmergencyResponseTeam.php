...
class EmergencyResponseTeam {
    ...
    public static function getInstance() {
        ...
        $postFromDB->role1 = $customFields['role1'][0];
        ...
        $postFromDB->role2 = $customFields['role2'][0];
        ...
        $postFromDB->role3 = $customFields['role3'][0];
        ...
        $postFromDB->role4 = $customFields['role4'][0];
        ...
        $postFromDB->role5 = $customFields['role5'][0];
        ...
        $postFromDB->role6 = $customFields['role6'][0];
        ...
        $postFromDB->role7 = $customFields['role7'][0];
        ...
        $postFromDB->role8 = $customFields['role8'][0];
        ...
        $postFromDB->role9 = $customFields['role9'][0];
        ...
        $postFromDB->role10 = $customFields['role10'][0];
        ...
        $postFromDB->role11 = $customFields['role11'][0];
        ...
        $postFromDB->role12 = $customFields['role12'][0];
    ...
    public static function fromForm($postRequest) {
        ...
        $instance->role1 = $postArray['role1'] ?? $instance->role1;
        ...
        $instance->role2 = $postArray['role2'] ?? $instance->role2;
        ...
        $instance->role3 = $postArray['role3'] ?? $instance->role3;
        ...
        $instance->role4 = $postArray['role4'] ?? $instance->role4;
        ...
        $instance->role5 = $postArray['role5'] ?? $instance->role5;
        ...
        $instance->role6 = $postArray['role6'] ?? $instance->role6;
        ...
        $instance->role7 = $postArray['role7'] ?? $instance->role7;
        ...
        $instance->role8 = $postArray['role8'] ?? $instance->role8;
        ...
        $instance->role9 = $postArray['role9'] ?? $instance->role9;
        ...
        $instance->role10 = $postArray['role10'] ?? $instance->role10;
        ...
        $instance->role11 = $postArray['role11'] ?? $instance->role11;
        ...
        $instance->role12 = $postArray['role12'] ?? $instance->role12;
    ...
    public function save() {
        ...
        if (is_wp_error($saveResult)) {
            ...
            WPCore::updatePostMeta($postID, 'role1', $post['role1']);
            ...
            WPCore::updatePostMeta($postID, 'role2', $post['role2']);
            ...
            WPCore::updatePostMeta($postID, 'role3', $post['role3']);
            ...
            WPCore::updatePostMeta($postID, 'role4', $post['role4']);
            ...
            WPCore::updatePostMeta($postID, 'role5', $post['role5']);
            ...
            WPCore::updatePostMeta($postID, 'role6', $post['role6']);
            ...
            WPCore::updatePostMeta($postID, 'role7', $post['role7']);
            ...
            WPCore::updatePostMeta($postID, 'role8', $post['role8']);
            ...
            WPCore::updatePostMeta($postID, 'role9', $post['role9']);
            ...
            WPCore::updatePostMeta($postID, 'role10', $post['role10']);
            ...
            WPCore::updatePostMeta($postID, 'role11', $post['role11']);
            ...
            WPCore::updatePostMeta($postID, 'role12', $post['role12']);
