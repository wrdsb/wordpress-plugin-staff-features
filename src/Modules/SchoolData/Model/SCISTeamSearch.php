...
class SCISTeamSearch {
    ...
    public static function audit() {
        ...
        $search_params['filter']  = "post_type eq 'scisteam'";
        $search_params['orderby'] = 'post_title';
        $search_params['search']  = '*';
        $search_params['select']  = '*';
        $search_params['top']     = '200';

        $search = new SCISTeamSearch($search_params);
        $search->run();
    ...
    public static function getBySchoolCode($schoolCode) {
        ...
        $search_params = [];
        $search_params['count']   = true;
        $search_params['filter']  = "post_type eq 'scisteam' and schoolCode eq '{$schoolCode}'";
        $search_params['orderby'] = 'post_title';
        $search_params['search']  = '*';
        $search_params['select']  = '*';
        $search_params['top']     = '200';
