            ...
            <div class="col-sm-9 col-lg-9" role="main">
				...
				<form id="editWorkplaceInspectionTeam">
					...
					<fieldset>
						...
						<input type="text" value="" id="principal-firstname" name="principalFirstname" aria-invalid="false" aria-labelledby="label-principal-firstname"><br />
						<label for="principal-lastname" id="label-principal-lastname"><span class="sr-only">Principal </span>Lastname</label>
						<input type="text" value="" id="principal-lastname" name="principalLastname" aria-invalid="false" aria-labelledby="label-principal-lastname"><br />
						...
						<input id="principal-h-s-contact" name="principalHSContact" type="checkbox" value="1" aria-labelledby="label-principal-h-s-contact">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="custodian-firstname" name="custodianFirstname" aria-invalid="false" aria-labelledby="label-custodian-firstname"><br />
						<label for="custodian-lastname" id="label-custodian-lastname"><span class="sr-only">Custodian </span>Lastname</label>
						<input type="text" value="" id="custodian-lastname" name="custodianLastname" aria-invalid="false" aria-labelledby="label-custodian-lastname"><br />
						...
						<input id="custodian-h-s-contact" name="custodianHSContact" type="checkbox" value="1" aria-labelledby="label-custodian-h-s-contact">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="staff-member-1-firstname" name="staffMember1Firstname" aria-invalid="false" aria-labelledby="label-staff-member-1-firstname"><br />
						<label for="staff-member-1-lastname" id="label-staff-member-1-lastname"><span class="sr-only">Staff Member 1 </span>Lastname</label>
						<input type="text" value="" id="staff-member-1-lastname" name="staffMember1Lastname" aria-invalid="false" aria-labelledby="label-staff-member-1-lastname"><br />
						...
						<input id="staff-member-1-h-s-contact" name="staffMember1HSContact" type="checkbox" value="1" aria-labelledby="label-staff-member-1-h-s-contact">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="staff-member-2-firstname" name="staffMember2Firstname" aria-invalid="false" aria-labelledby="label-staff-member-2-firstname"><br />
						<label for="staff-member-2-lastname" id="label-staff-member-2-lastname"><span class="sr-only">Staff Member 2 </span>Lastname</label>
						<input type="text" value="" id="staff-member-2-lastname" name="staffMember2Lastname" aria-invalid="false" aria-labelledby="label-staff-member-2-lastname"><br />
						...
						<input id="staff-member-2-h-s-contact" name="staffMember2HSContact" type="checkbox" value="1" aria-labelledby="label-staff-member-2-h-s-contact">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="staff-member-3-firstname" name="staffMember3Firstname" aria-invalid="false" aria-labelledby="label-staff-member-3-firstname"><br />
						<label for="staff-member-3-lastname" id="label-staff-member-3-lastname"><span class="sr-only">Staff Member 3 </span>Lastname</label>
						<input type="text" value="" id="staff-member-3-lastname" name="staffMember3Lastname" aria-invalid="false" aria-labelledby="label-staff-member-3-lastname"><br />
						...
						<input id="staff-member-3-h-s-contact" name="staffMember3HSContact" type="checkbox" value="1" aria-labelledby="label-staff-member-3-h-s-contact">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="staff-member-4-firstname" name="staffMember4Firstname" aria-invalid="false" aria-labelledby="label-staff-member-4-firstname"><br />
						...
						<input type="text" value="" id="staff-member-4-lastname" name="staffMember4Lastname" aria-invalid="false" aria-labelledby="label-staff-member-4-lastname"><br />
						...
						<input id="staff-member-4-h-s-contact" name="staffMember4HSContact" type="checkbox" value="1" aria-labelledby="label-staff-member-4-h-s-contact">
					</fieldset>
