            ...
            <div class="col-sm-9 col-lg-9" role="main">
				...
				<form id="editSCISTeam" action="<?php echo WPCore::homeURL(); ?>/wp-admin/admin-post.php" method="post">
					...
					<fieldset>
						...
						<input type="text" value="" id="administrator-firstname" name="administratorFirstname" aria-invalid="false" aria-labelledby="label-administrator-firstname"><br />
						<label for="administrator-lastname" id="label-administrator-lastname"><span class="sr-only">Administrator </span>Lastname</label>
						<input type="text" value="" id="administrator-lastname" name="administratorLastname" aria-invalid="false" aria-labelledby="label-administrator-lastname"><br />
						...
						<input id="administrator-i-e-liasion" name="administratorIELiasion" type="checkbox" value="1" aria-labelledby="label-administrator-i-e-liasion">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="teacher-firstname" name="teacherFirstname" aria-invalid="false" aria-labelledby="label-teacher-firstname"><br />
						<label for="teacher-lastname" id="label-teacher-lastname"><span class="sr-only">Teacher </span>Lastname</label>
						<input type="text" value="" id="teacher-lastname" name="teacherLastname" aria-invalid="false" aria-labelledby="label-teacher-lastname"><br />
						...
						<input id="teacher-i-e-liasion" name="teacherIELiasion" type="checkbox" value="1" aria-labelledby="label-teacher-i-e-liasion">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="paraprofessional-firstname" name="paraprofessionalFirstname" aria-invalid="false" aria-labelledby="label-paraprofessional-firstname"><br />
						...
						<input type="text" value="" id="paraprofessional-lastname" name="paraprofessionalLastname" aria-invalid="false" aria-labelledby="label-paraprofessional-lastname"><br />
						<label for="paraprofessional-i-e-liasion" id="label-paraprofessional-i-e-liasion">Indigenous &amp; Equity Liaison</label>
						<input id="paraprofessional-i-e-liasion" name="paraprofessionalIELiasion" type="checkbox" value="1" aria-labelledby="label-paraprofessional-i-e-liasion">
					</fieldset>

					<fieldset>
						<legend>Parent</legend>
						<label for="parent-firstname" id="label-parent-firstname"><span class="sr-only">Parent </span>Firstname</label>
						<input type="text" value="" id="parent-firstname" name="parentFirstname" aria-invalid="false" aria-labelledby="label-parent-firstname"><br />
						<label for="parent-lastname" id="label-parent-lastname"><span class="sr-only">Parent </span>Lastname</label>
						<input type="text" value="" id="parent-lastname" name="parentLastname" aria-invalid="false" aria-labelledby="label-parent-lastname"><br />
						...
						<input id="parent-i-e-liasion" name="parentIELiasion" type="checkbox" value="1" aria-labelledby="label-parent-i-e-liasion">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="community-member-firstname" name="communityMemberFirstname" aria-invalid="false" aria-labelledby="label-community-member-firstname"><br />
						...
						<input type="text" value="" id="community-member-lastname" name="communityMemberLastname" aria-invalid="false" aria-labelledby="label-community-member-lastname"><br />
						...
						<input id="community-member-i-e-liasion" name="communityMemberIELiasion" type="checkbox" value="1" aria-labelledby="label-community-member-i-e-liasion">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="student-1-firstname" name="student1Firstname" aria-invalid="false" aria-labelledby="label-student-1-firstname"><br />
						<label for="student-1-lastname" id="label-student-1-lastname"><span class="sr-only">Student 1 </span> Lastname</label>
						<input type="text" value="" id="student-1-lastname" name="student1Lastname" aria-invalid="false" aria-labelledby="label-student-1-lastname"><br />
						...
						<input id="student-1-i-e-liasion" name="student1IELiasion" type="checkbox" value="1" aria-labelledby="label-student-1-i-e-liasion">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="student-2-firstname" name="student2Firstname" aria-invalid="false" aria-labelledby="label-student-2-firstname"><br />
						<label for="student-2-lastname" id="label-student-2-lastname"><span class="sr-only">Student 2 </span> Lastname</label>
						<input type="text" value="" id="student-2-lastname" name="student2Lastname" aria-invalid="false" aria-labelledby="label-student-2-lastname"><br />
						...
						<input id="student-2-i-e-liasion" name="student2IELiasion" type="checkbox" value="1" aria-labelledby="label-student-2-i-e-liasion">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="optional-1-firstname" name="optional1Firstname" aria-invalid="false" aria-labelledby="label-optional-1-firstname"><br />
						...
						<input type="text" value="" id="optional-1-lastname" name="optional1Lastname" aria-invalid="false" aria-labelledby="label-optional-1-lastname"><br />
						...
						<input id="optional-1-i-e-liasion" name="optional1IELiasion" type="checkbox" value="1" aria-labelledby="label-optional-1-i-e-liasion">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="optional-2-firstname" name="optional2Firstname" aria-invalid="false" aria-labelledby="label-optional-2-firstname"><br />
						...
						<input type="text" value="" id="optional-2-lastname" name="optional2Lastname" aria-invalid="false" aria-labelledby="label-optional-2-lastname"><br />
						...
						<input id="optional-2-i-e-liasion" name="optional2IELiasion" type="checkbox" value="1" aria-labelledby="label-optional-2-i-e-liasion">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="optional-3-firstname" name="optional3Firstname" aria-invalid="false" aria-labelledby="label-optional-3-firstname"><br />
						...
						<input type="text" value="" id="optional-3-lastname" name="optional3Lastname" aria-invalid="false" aria-labelledby="label-optional-3-lastname"><br />
						...
						<input id="optional-3-i-e-liasion" name="optional3IELiasion" type="checkbox" value="1" aria-labelledby="label-optional-3-i-e-liasion">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="optional-4-firstname" name="optional4Firstname" aria-invalid="false" aria-labelledby="label-optional-4-firstname"><br />
						...
						<input type="text" value="" id="optional-4-lastname" name="optional4Lastname" aria-invalid="false" aria-labelledby="label-optional-4-lastname"><br />
						...
						<input id="optional-4-i-e-liasion" name="optional4IELiasion" type="checkbox" value="1" aria-labelledby="label-optional-4-i-e-liasion">
					</fieldset>
					...
					<fieldset>
						...
						<input type="text" value="" id="optional-5-firstname" name="optional5Firstname" aria-invalid="false" aria-labelledby="label-optional-5-firstname"><br />
						...
						<input type="text" value="" id="optional-5-lastname" name="optional5Lastname" aria-invalid="false" aria-labelledby="label-optional-5-lastname"><br />
						...
						<input id="optional-5-i-e-liasion" name="optional5IELiasion" type="checkbox" value="1" aria-labelledby="label-optional-5-i-e-liasion">
					</fieldset>
