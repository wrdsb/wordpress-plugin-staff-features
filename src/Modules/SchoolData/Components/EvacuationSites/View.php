            ...
            <div class="col-sm-9 col-lg-9" role="main">
                ...
                <form id="viewEvacuationSites">
					...
					<fieldset>
						...
						<input disabled type="time" value="<?php echo $currentInstance->getSite2HoursStart(); ?>" id="site-1-hours-start" name="site1HoursStart" aria-invalid="false" aria-labelledby="label-site-2-hours-start"><br />
