            ...
            <div class="col-sm-9 col-lg-9" role="main">
                ...
                <form id="viewEvacuationSites">
					...
					<fieldset>
						...
						<input disabled type="text" value="<?php echo $currentInstance->getSite1Name(); ?>" id="site-1-name" name="site1Name" aria-invalid="false" aria-labelledby="label-site-1-name">
						...
						<input disabled type="text" value="<?php echo $currentInstance->getSite1Lastname(); ?>" id="site-1-lastname" name="site1Lastname" aria-invalid="false" aria-labelledby="label-site-1-lastname">
						...
						<input disabled type="time" value="<?php echo $currentInstance->getSite1HoursStart(); ?>" id="site-1-hours-start" name="site1HoursStart" aria-invalid="false" aria-labelledby="label-site-1-hours-start">
					...
					<fieldset>
						...
						<input disabled type="text" value="<?php echo $currentInstance->getSite2Name(); ?>" id="site-2-name" name="site2Name" aria-invalid="false" aria-labelledby="label-site-2-name">
						...
						<input disabled type="text" value="<?php echo $currentInstance->getSite2Lastname(); ?>" id="site-2-lastname" name="site2Lastname" aria-invalid="false" aria-labelledby="label-site-2-lastname">
						...
						<input disabled type="time" value="<?php echo $currentInstance->getSite2HoursStart(); ?>" id="site-1-hours-start" name="site1HoursStart" aria-invalid="false" aria-labelledby="label-site-2-hours-start">
					...
					<fieldset>
						...
						<input disabled type="text" value="<?php echo $currentInstance->getSite3Name(); ?>" id="site-3-name" name="site3Name" aria-invalid="false" aria-labelledby="label-site-3-name">
						...
						<input disabled type="text" value="<?php echo $currentInstance->getSite3Lastname(); ?>" id="site-3-lastname" name="site3Lastname" aria-invalid="false" aria-labelledby="label-site-3-lastname">
						...
						<input disabled type="time" value="<?php echo $currentInstance->getSite3HoursStart(); ?>" id="site-3-hours-start" name="site3HoursStart" aria-invalid="false" aria-labelledby="label-site-3-hours-start">
					...
					<fieldset>
						...
						<input disabled type="text" value="<?php echo $currentInstance->getSite4Name(); ?>" id="site-4-name" name="site4Name" aria-invalid="false" aria-labelledby="label-site-4-name">
						...
						<input disabled type="text" value="<?php echo $currentInstance->getSite4Lastname(); ?>" id="site-4-lastname" name="site4Lastname" aria-invalid="false" aria-labelledby="label-site-4-lastname">
						...
						<input disabled type="time" value="<?php echo $currentInstance->getSite4HoursStart(); ?>" id="site-4-hours-start" name="site4HoursStart" aria-invalid="false" aria-labelledby="label-site-4-hours-start">
