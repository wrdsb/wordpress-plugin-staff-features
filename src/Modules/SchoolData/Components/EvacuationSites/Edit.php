            ...
            <div class="col-sm-9 col-lg-9" role="main">
                ...
                <form id="editEvacuationSites" action="<?php echo WPCore::homeURL(); ?>/wp-admin/admin-post.php" method="post">
					...
					<fieldset>
						...
						<input type="time" value="<?php echo $currentInstance->getSite2HoursStart(); ?>" id="site-1-hours-start" name="site1HoursStart" aria-invalid="false" aria-labelledby="label-site-2-hours-start"><br />
