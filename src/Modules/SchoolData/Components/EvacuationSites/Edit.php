            ...
            <div class="col-sm-9 col-lg-9" role="main">
                ...
                <form id="editEvacuationSites">
					...
					<fieldset>
						...
						<input type="text" value="" id="site-1-postal-code" name="site-1-postal-code" aria-invalid="false" aria-labelledby="label-site-1-postal-code"><br />
						...
						<input type="text" value="" id="site-1-phone" name="site-1-phone" aria-invalid="false" aria-labelledby="label-site-1-phone"><br />
					...
					<fieldset>
						...
						<input type="text" value="" id="site-2-postal-code" name="site-2-postal-code" aria-invalid="false" aria-labelledby="label-site-2-postal-code"><br />
						...
						<input type="text" value="" id="site-2-phone" name="site-2-phone" aria-invalid="false" aria-labelledby="label-site-2-phone"><br />
					...
					<fieldset>
						...
						<input type="text" value="" id="site-3-postal-code" name="site-3-postal-code" aria-invalid="false" aria-labelledby="label-site-3-postal-code"><br />
						...
						<input type="text" value="" id="site-3-phone" name="site-3-phone" aria-invalid="false" aria-labelledby="label-site-3-phone"><br />
					...
					<fieldset>
						...
						<input type="text" value="" id="site-4-postal-code" name="site-4-postal-code" aria-invalid="false" aria-labelledby="label-site-4-postal-code"><br />
						...
						<input type="text" value="" id="site-4-phone" name="site-4-phone" aria-invalid="false" aria-labelledby="label-site-4-phone"><br />
