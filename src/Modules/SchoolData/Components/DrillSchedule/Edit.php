...
$schoolCode = strtoupper(WModule::getSchoolCode());
            ...
            <div class="col-sm-9 col-lg-9" role="main">
                ...
                <form id="editDrillSchedule" action="<?php echo WPCore::homeURL(); ?>/wp-admin/admin-post.php" method="post">
                    ...
                    <fieldset>
                        ...
                        <input id="bomb-drill-date" name="bombDrill1Date" aria-invalid="false" aria-labelledby="label-bomb-drill-date" type="date" value="<?php echo $currentInstance->getBombDrill1Date(); ?>">
