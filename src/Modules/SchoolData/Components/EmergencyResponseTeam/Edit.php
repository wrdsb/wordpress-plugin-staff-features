            ...
            <div class="col-sm-9 col-lg-9" role="main">
				...
				<form id="editEmergencyResponseTeam" action="<?php echo WPCore::homeURL(); ?>/wp-admin/admin-post.php" method="post">
					...
					<fieldset>
						...
						<input id="cpr-expiry-1" name="cprExpiry1" aria-invalid="false" aria-labelledby="label-cpr-expiry-1" type="date" value="<?php echo $currentInstance->getCPRExpiry1(); ?>">
						<label for="first-aid-expiry-1" id="label-first-aid-expiry-1">First Aid Expiry<span class="sr-only"> 1</span></label>
						<input id="first-aid-expiry-1" name="firstAidExpiry1" aria-invalid="false" aria-labelledby="label-first-aid-expiry-1" type="date" value="<?php echo $currentInstance->getFirstAidExpiry1(); ?>">
					...
					<fieldset>
						...
						<input id="cpr-expiry-2" name="cprExpiry2" aria-invalid="false" aria-labelledby="label-cpr-expiry-2" type="date" value="<?php echo $currentInstance->getCPRExpiry2(); ?>">
						<label for="first-aid-expiry-2" id="label-first-aid-expiry-2">First Aid Expiry<span class="sr-only"> 2</span></label>
						<input id="first-aid-expiry-2" name="firstAidExpiry2" aria-invalid="false" aria-labelledby="label-first-aid-expiry-2" type="date" value="<?php echo $currentInstance->getFirstAidExpiry2(); ?>">
					...
					<fieldset>
						...
						<input id="cpr-expiry-3" name="cprExpiry3" aria-invalid="false" aria-labelledby="label-cpr-expiry-3" type="date" value="<?php echo $currentInstance->getCPRExpiry3(); ?>">
						<label for="first-aid-expiry-3" id="label-first-aid-expiry-3">First Aid Expiry<span class="sr-only"> 3</span></label>
						<input id="first-aid-expiry-3" name="firstAidExpiry3" aria-invalid="false" aria-labelledby="label-first-aid-expiry-3" type="date" value="<?php echo $currentInstance->getFirstAidExpiry3(); ?>">
					...
					<fieldset>
						...
						<input id="cpr-expiry-4" name="cprExpiry4" aria-invalid="false" aria-labelledby="label-cpr-expiry-4" type="date" value="<?php echo $currentInstance->getCPRExpiry4(); ?>">
						<label for="first-aid-expiry-4" id="label-first-aid-expiry-4">First Aid Expiry<span class="sr-only"> 4</span></label>
						<input id="first-aid-expiry-4" name="firstAidExpiry4" aria-invalid="false" aria-labelledby="label-first-aid-expiry-4" type="date" value="<?php echo $currentInstance->getFirstAidExpiry4(); ?>">
					...
					<fieldset>
						...
						<input id="cpr-expiry-5" name="cprExpiry5" aria-invalid="false" aria-labelledby="label-cpr-expiry-5" type="date" value="<?php echo $currentInstance->getCPRExpiry5(); ?>">
						<label for="first-aid-expiry-5" id="label-first-aid-expiry-5">First Aid Expiry<span class="sr-only"> 5</span></label>
						<input id="first-aid-expiry-5" name="firstAidExpiry5" aria-invalid="false" aria-labelledby="label-first-aid-expiry-5" type="date" value="<?php echo $currentInstance->getFirstAidExpiry5(); ?>">
					...
					<fieldset>
						...
						<input id="cpr-expiry-6" name="cprExpiry6" aria-invalid="false" aria-labelledby="label-cpr-expiry-6" type="date" value="<?php echo $currentInstance->getCPRExpiry6(); ?>">
						<label for="first-aid-expiry-6" id="label-first-aid-expiry-6">First Aid Expiry<span class="sr-only"> 6</span></label>
						<input id="first-aid-expiry-6" name="firstAidExpiry6" aria-invalid="false" aria-labelledby="label-first-aid-expiry-6" type="date" value="<?php echo $currentInstance->getFirstAidExpiry6(); ?>">
					...
					<fieldset>
						...
						<input id="cpr-expiry-7" name="cprExpiry7" aria-invalid="false" aria-labelledby="label-cpr-expiry-7" type="date" value="<?php echo $currentInstance->getCPRExpiry7(); ?>">
						<label for="first-aid-expiry-7" id="label-first-aid-expiry-7">First Aid Expiry<span class="sr-only"> 7</span></label>
						<input id="first-aid-expiry-7" name="firstAidExpiry7" aria-invalid="false" aria-labelledby="label-first-aid-expiry-7" type="date" value="<?php echo $currentInstance->getFirstAidExpiry7(); ?>">
					...
					<fieldset>
						...
						<input id="cpr-expiry-8" name="cprExpiry8" aria-invalid="false" aria-labelledby="label-cpr-expiry-8" type="date" value="<?php echo $currentInstance->getCPRExpiry8(); ?>">
						<label for="first-aid-expiry-8" id="label-first-aid-expiry-8">First Aid Expiry<span class="sr-only"> 8</span></label>
						<input id="first-aid-expiry-8" name="firstAidExpiry8" aria-invalid="false" aria-labelledby="label-first-aid-expiry-8" type="date" value="<?php echo $currentInstance->getFirstAidExpiry8(); ?>">
					...
					<fieldset>
						...
						<input id="cpr-expiry-9" name="cprExpiry9" aria-invalid="false" aria-labelledby="label-cpr-expiry-9" type="date" value="<?php echo $currentInstance->getCPRExpiry9(); ?>">
						<label for="first-aid-expiry-9" id="label-first-aid-expiry-9">First Aid Expiry<span class="sr-only"> 9</span></label>
						<input id="first-aid-expiry-9" name="firstAidExpiry9" aria-invalid="false" aria-labelledby="label-first-aid-expiry-9" type="date" value="<?php echo $currentInstance->getFirstAidExpiry9(); ?>">
					...
					<fieldset>
						...
						<input id="cpr-expiry-10" name="cprExpiry10" aria-invalid="false" aria-labelledby="label-cpr-expiry-10" type="date" value="<?php echo $currentInstance->getCPRExpiry10(); ?>">
						<label for="first-aid-expiry-10" id="label-first-aid-expiry-10">First Aid Expiry<span class="sr-only"> 10</span></label>
						<input id="first-aid-expiry-10" name="firstAidExpiry10" aria-invalid="false" aria-labelledby="label-first-aid-expiry-10" type="date" value="<?php echo $currentInstance->getFirstAidExpiry10(); ?>">
					...
					<fieldset>
						...
						<input id="cpr-expiry-11" name="cprExpiry11" aria-invalid="false" aria-labelledby="label-cpr-expiry-11" type="date" value="<?php echo $currentInstance->getCPRExpiry11(); ?>">
						<label for="first-aid-expiry-11" id="label-first-aid-expiry-11">First Aid Expiry<span class="sr-only"> 11</span></label>
						<input id="first-aid-expiry-11" name="firstAidExpiry11" aria-invalid="false" aria-labelledby="label-first-aid-expiry-11" type="date" value="<?php echo $currentInstance->getFirstAidExpiry11(); ?>">
					...
					<fieldset>
						...
						<input id="cpr-expiry-12" name="cprExpiry12" aria-invalid="false" aria-labelledby="label-cpr-expiry-12" type="date" value="<?php echo $currentInstance->getCPRExpiry12(); ?>">
						<label for="first-aid-expiry-12" id="label-first-aid-expiry-12">First Aid Expiry<span class="sr-only"> 12</span></label>
						<input id="first-aid-expiry-12" name="firstAidExpiry12" aria-invalid="false" aria-labelledby="label-first-aid-expiry-12" type="date" value="<?php echo $currentInstance->getFirstAidExpiry12(); ?>">
