...
$page_title = "SCIS Team Instructions";
    ...
    <?php } else { ?>
        ...
        <div class="container container-breadcrumb" role="navigation">
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo WPCore::homeURL(); ?>/school-data/scis-team">SCIS Team</a>
                </li>
                <li>
                    <?php echo $page_title; ?>
                </li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9 col-lg-9" role="main">
                ...
                <p>Each school must have in place a Safe, Caring and Inclusive Schools team. The school-based Safe, Caring and Inclusive Schools team will operate in accordance with the SCIS Terms of Reference, school code of conduct, Board policies and procedures, Ministry of Education directions for school boards, and align with other relevant legislation, including the Canadian Charter of Rights and Freedoms and the Ontario Human Rights Code. Safe, Caring and Inclusive Schools teams will consist of a minimum of seven members, as follows:</p>
                <ul>
